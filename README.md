...
![Imagem](images/Landpage.png)

- **Tecnologias Utilizadas:** HTML, CSS, Bootstrap
- **Descrição:** Um projeto para demonstrar a criação de uma landpage elegante, rápida e responsiva.
- **Links:**
  - [Abrir](https://gustav-stack.github.io/Tindog/)
  - [Ver Código](https://github.com/Gustav-Stack/Tindog)

### NewsLetter

![Imagem](images/NewsLetter.png)
